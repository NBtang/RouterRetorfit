...
abstract class ParameterHandler<T> {
    ...
    static final class ContextParameter extends ParameterHandler<Context> {
    ...
    static final class FragmentParameter extends ParameterHandler<Fragment> {

        @Override
        void apply(RequestBuilder builder, @Nullable Fragment value) {
    ...
    static final class RequestCode extends ParameterHandler<Integer> {
        ...
        @Override
        void apply(RequestBuilder builder, @Nullable Integer value) {
            checkNotNull(value, "@RequestCode parameter is null.");
            builder.setRequestCode(value);
        }
    }
    ...
    static final class Action extends ParameterHandler<String> {
        ...
        @Override
        void apply(RequestBuilder builder, @Nullable String value) {
            checkNotNull(value, "@Action parameter is null.");
